import{j as r}from"./jsx-runtime-0DLF9kdB.js";import{L as n,r as l}from"./components-QUucBwvO.js";import{l as x,aC as m,J as p}from"./lib-DGfPmdxF.js";const h=({listing:e})=>r.jsxs("div",{children:[e==null?void 0:e.address_one,e!=null&&e.address_two?`, ${e==null?void 0:e.address_two}`:"",e!=null&&e.city_name?`, ${e==null?void 0:e.city_name}`:"",e!=null&&e.state_name?`, ${e==null?void 0:e.state_name}`:"",e!=null&&e.country_name?`, ${e==null?void 0:e.country_name}`:""]});function y({rating:e}){return r.jsx("div",{className:"flex gap-x-[2px]",children:Array.from({length:5}).map((a,o)=>{const t=Math.max(0,Math.min(1,e-o))*100;return r.jsx("div",{className:`relative w-[17px] h-[17px] bg-white rounded-full 
